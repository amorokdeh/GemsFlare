...
export function EditShippingAddressForm({ address, onAddressUpdated }: EditShippingAddressFormProps) {
  ...
  async function onSubmit(data: AddressFormValues) {
    ...
    try {
      ...
      await userService.editShippingAddress(addressData);
      ...
      toast({
        variant: "destructive",
        title: "Update failed",
        description: error instanceof Error ? error.message : "Failed to update shipping address. Please try again."
      });
    } finally {
  ...
  return (
    <Sheet open={isOpen} onOpenChange={setIsOpen}>
      ...
      <SheetContent className="overflow-y-auto">
        <SheetHeader>
          <SheetTitle>Edit Shipping Address</SheetTitle>
          <SheetDescription>
